            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a  target="_blank" style="text-decoration: none;" class="btn-link" href={{ route('user',$answer->question->user->id) }}> <img src="../profile_default.png" class="img-circle" width="30" height="30">
                     ...
                     <div class="panel-body">
                       ...
                       <a href="{{ route('answer',$answer->question->id) }}" class="btn btn-info">Answer</a>
                    </div>
                </div>
            </div>
        </div>
