        ...
        <div class="profInnerContainer">
            <div class="profHeader">
                <div class="profHeaderUpper">
                    <div class="profHeaderLogo" style="background: url(logoBlue.png); background-size: 50px 50px; background-position: center; background-repeat: no-repeat;"></div>
                    ...
                    <div class="profDropDown">
                        <a href="#" class="profDropDownInner" style="background: url(images/profilepic.jpg); background-size: 50px 50px; width: 50px; height: 50px; align-self: center; margin: 0px auto; border-radius: 100%;"></a>
                        <!--
                ...
                <div class="leftBox">
                    <div class="personOverviewBox">
                        <div class="personOverviewBoxItems basicProfInfo">
                            <div class="personProfilePic" style="background: url(images/profilepic.jpg); background-size: cover; background-position: center;">
                            </div>
                            <h3 class="profileName">Steve Jobs</h3>
                        ...
                        <div class="personPosts">
                            ...
                            <div class="personPostLinksOuter">
                                <div class="personPostsLink">
                                    <div class="personPostPic" style="background: url(images/postpic1.jpg); height: 150px; background-size: cover; background-position: center; border-radius: 4px;"></div>
                                ...
                                <div class="personPostsLink">
                                    <div class="personPostPic" style="background: url(images/postpic2.jpg); height: 150px; background-size: cover; background-position: center; border-radius: 4px;"></div>
                                    <div class="personPostHeading">
                                ...
                                <div class="personPostsLink">
                                    <div class="personPostPic" style="background: url(images/postpic3.jpg); height: 150px; background-size: cover; background-position: center; border-radius: 4px;"></div>
                                    <div class="personPostHeading">
                                        ...
                                        <div class="profSummaryData">
                                            ...
                                            <div class="profSummaryDataRight">
                                                <div class="profEachJob">
                                                    ...
                                                    <div class="expLogo" style="background: url(images/apple.png); background-size: contain; background-repeat: no-repeat; pakground-position: center;">
                                                    </div>
                                                </div>
                                                <div class="profEachJob notFirst">
                                                    <div class="profEachExp">
                                                        <h4 class="expPeriod">2015 - PRESENT</h4>
                                                        <h3 class="expPosition">Co-founder, CEO</h3>
                                                        <h3 class="expCompany">Apple Inc.</h3>
                                        ...
                                        <div class="profSummaryData">
                                            ...
                                            <div class="profSummaryDataRight">
                                                <div class="profEachJob">
                                                    ...
                                                    <div class="expLogo" style="background: url(images/gla.png); background-size: contain; background-repeat: no-repeat; pakground-position: center;">
                                                    </div>
                                                </div>
                                                <div class="profEachJob notFirst">
                                                    <div class="profEachExp">
                                        ...
                                        <div class="profSummaryData">
                                            ...
                                            <div class="profSummaryDataRight">
                                                <div class="skillsOuter">
                                                    <div class="singleSkill">Web Development</div>
                                                    <div class="singleSkill">HTML</div>
                                                    <div class="singleSkill">CSS</div>
                                                    <div class="singleSkill">Logo Design</div>
                                                    <div class="singleSkill">Java</div>
                                                    <div class="singleSkill">Office</div>
                                                    <div class="singleSkill">Photography</div>
                                                    <div class="singleSkill">JavaScript</div>
                                                    <div class="singleSkill">C</div>
                                                    <div class="singleSkill">Linux</div>
                                                    <div class="singleSkill">Android</div>
                                                    <div class="singleSkill">Database</div>
                                                    <div class="singleSkill">Netbeans</div>
                                                    <div class="singleSkill">PHP</div>
                                                    <div class="singleSkill">SQL</div>
                                                    <div class="singleSkill">Public Speaking</div>
                                                    <div class="singleSkill">Illustrator</div>
                                                    <div class="singleSkill">Photoshop</div>
                                                    <div class="singleSkill">Blogging</div>
                                                    <div class="singleSkill">Drawing</div>
                                                    <div class="singleSkill">HTML5</div>
                                                    <div class="singleSkill">Grunt</div>
                                                    <div class="singleSkill">Gulp</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="profSummaryData">
                                            ...
                                            <div class="profSummaryDataRight">
                                                <div class="profEachProject">
                                                    <div class="profEachExp">
                                                        <h3 class="expPosition">Cotanz College Connect</h3>
                                                        <h4 class="expPeriod">2015 - PRESENT</h4>
                                                        <p class="projectDetail">This website is build for helping the people to create their resume. As in the beginning before we are searching for idea for the project then we decided that we'll develop something which will help thousand or millions of people. We choose to make a resume building website because each and everyone in his life once needs a resume and it's not the secondary thing for any interview but if you are applying for job then it's the primary or must thing and it must be creative and one in a millions if you are applying for a good company like Google, Microsoft or Apple. After choosing it as a topic we decided to provide it free to all.
                                                            <br> It's free and always will be. We do a lot more research on it. The things which we are providing are not less than thousand dollars if one hire a consultant. We consult many consultants and search on many sites and after a long discussion with HR's we are able to complete this. It's awesome and It really Help as Our MOTTO describes.. Create Your Resume & Resume Your Job.</p>
                                                    </div>
                                                </div>
                                                <div class="profEachProject notFirst">
                                                    <div class="profEachExp">
                                                        <h3 class="expPosition">Summa - The Resume Builder</h3>
                                                        <h4 class="expPeriod">2014 - 15</h4>
                                                        <p class="projectDetail">This website is build for helping the people to create their resume. As in the beginning before we are searching for idea for the project then we decided that we'll develop something which will help thousand or millions of people. We choose to make a resume building website because each and everyone in his life once needs a resume and it's not the secondary thing for any interview but if you are applying for job then it's the primary or must thing and it must be creative and one in a millions if you are applying for a good company like Google, Microsoft or Apple. After choosing it as a topic we decided to provide it free to all.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="personPostLinksOuter">
                                <div class="personPostsLink">
                                    <div class="personRecc">
                                        "He is a great Guy, works well, visionary, Hard worker and sometimes very very helpfull. Great developer, leader, sports-person and team worker hello hel. It's my pleasure to work with him..."
                                    </div>
                                    <div class="personPostHeading">
                                        <h4>Abhishek Kumar Singh</h4></div>
                                    <div class="personPostTime">
                                        <h6>Cotanz</h6></div>
                                </div>
                                <div class="personPostsLink">
