    ...
    <div class="profHeader">
        <div class="profHeaderUpper">
            ...
            <div class="profHeaderMainMenu">
                <a href="{{ route('home')}}" class="mainMenuItemList mainMenuItem1">Home</a>
                ...
                <a href="#" class="mainMenuItemList mainMenuItem3">Edit profile</a>
            ...
            <div class="profDropDown">
                <a href="#" class="profDropDownInner" style=" background-size: 50px 50px; width: 50px; height: 50px; align-self: center; margin: 0px auto; border-radius: 100%;"></a>
                <!--
